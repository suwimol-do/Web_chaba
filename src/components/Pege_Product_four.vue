<template>
  <a-layout id="components-layout-demo-side" style="min-height: 100vh">
    <a-layout-sider v-model="collapsed" collapsible>
      ...
      <!-- | -->
      <div class="logo" />
      <a-menu theme="dark" :default-selected-keys="['16']" mode="inline">
        <a-menu-item key="1">
          <a-icon type="home" />
          <span>Home</span>
          <a href="home">Home</a>
    ...
    <a-layout>
      ...
      <a-layout-content style="margin: 0 16px">
        <a-breadcrumb style="margin: 16px 0">
          <a-breadcrumb-item
            >สินค้าขึ้นชื่อของปราสาทหินบ้านพลวง</a-breadcrumb-item
          >
            ...
            <a-row type="flex" justify="center">
              <a-col :span="4">
                <a-card hoverable style="width: 400px">
                  <img slot="cover" alt="example" src="../assets/ยาหม่อง.jpg" />
                  ...
                  <div>
                    ...
                    >
                      ...
                      <p>ประเภทสินค้า :สมุนไพรที่ไม่ใช่อาหาร</p>
                      <p>
                        กลุ่มสตรีผลิตการบูรหอมบ้านเชื้อเพลิงสามัคคี<br />
                        250 หมู่ที่ 12 บ้านเชื้อเพลิงสามัคคี ถนนสุรินทร์-ปราสาท
                        ตำบลเชื้อเพลิง อำเภอปราสาท จังหวัดสุรินทร์ 32140<br />
                        ติดต่อ : คุณบุญคำ รัตนูปการ<br />
                        โทร : 044-552222 , 044-552233<br />
                        Fax : 044-552233
                      </p>
                    </a-modal>
                  </div>
                  ...
                  <br />
                  <!-- ชื่อสินค้า -->
                  <a-card-meta title="ยาหม่องสมุนไพร">
                    <template slot="description"> 50.00 - 100.00 บาท</template>
                    <br />
                    <br />
                  </a-card-meta>
                </a-card>
              ...
              <a-col :span="4">
                <a-card hoverable style="width: 400px">
                  <img slot="cover" alt="example" src="../assets/การบรู.jpg" />
