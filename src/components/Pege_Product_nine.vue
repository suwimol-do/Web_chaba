    ...
    <a-layout>
      ...
      <a-layout-content style="margin: 0 16px">
        <a-breadcrumb style="margin: 16px 0">
          <a-breadcrumb-item
            >สินค้าขึ้นชื่อของศาลหลักเมืองสุรินทร์</a-breadcrumb-item
          >
            ...
            <a-row type="flex" justify="center">
              <a-col :span="4">
                <a-card hoverable style="width: 400px">
                  <img
                    slot="cover"
                    alt="example"
                    src="../assets/แชมพุสมุนไพรอัญชัน.jpg"
                  />
                  ...
                  <div>
                    ...
                    >
                      ...
                      <p>
                        ติดต่อ 094-3632512<br />
                        Facebook : ศูนย์แสดงและจำหน่ายสินค้าโอทอปจังหวัดสุรินทร์
                      </p>
                    </a-modal>
                  </div>
                  <br />
                  <br />
                  <!-- ชื่อสินค้า -->
                  <a-card-meta title="แชมพุสมุนไพรอัญชัน">
                    <template slot="description"> 150.00 บาท</template>
                    <br />
                    <br />
                  </a-card-meta>
                </a-card>
              ...
              <a-col :span="4">
                <a-card hoverable style="width: 400px">
                  ...
                  <br />
                  <!-- ชื่อสินค้า -->
                  <a-card-meta title="ขี้ผึ้งสมุนไพร">
                    <template slot="description"> 120.00 บาท </template>
                    <br />
                    <br />
                  </a-card-meta>
                </a-card>
