<template>
  <a-layout id="components-layout-demo-side" style="min-height: 100vh">
    <a-layout-sider v-model="collapsed" collapsible>
      ...
      <!-- | -->
      <div class="logo" />
      <a-menu theme="dark" :default-selected-keys="['8']" mode="inline">
        <a-menu-item key="1">
          <a-icon type="home" />
          <span>Home</span>
          <a href="home">Home</a>
        ...
        <a-sub-menu key="sub1">
          ...
          <a-menu-item key="6">
            ปราสาทหินบ้านพลวง
            <a href="locationfour"></a
          ></a-menu-item>
          <a-menu-item key="7">
            วัดบูรพาราม
            <a href="locationfive"></a
          ></a-menu-item>
          <a-menu-item key="8">
            อ่างเก็บน้ำห้วยเสนง <a href="locationsix"></a
          ></a-menu-item>
          <a-menu-item key="9">
            อนุสาวรีย์พระยาสุรินทรภักดีศรีณรงค์จางวาง
            <a href="locationseven"></a>
          </a-menu-item>
          <a-menu-item key="10">
        ...
        <a-sub-menu key="sub2">
          <span slot="title"
            ><a-icon type="shopping" /><span>Product</span></span
          >
          <a-menu-item key="13">
            สินค้าขึ้นชื่อของปราสาทศรีขมรภูมิ<a href="Productone"></a>
          </a-menu-item>
          <a-menu-item key="14">
          ...
          <a-menu-item key="17">
            สินค้าขึ้นชื่อของวัดบูรพาราม<a href="Productfive"></a>
          </a-menu-item>
          <a-menu-item key="18">
            สินค้าขึ้นชื่อของอ่างเก็บน้ำห้วยเสนง <a href="Productsix"></a>
          </a-menu-item>
          <a-menu-item key="19">
            สินค้าขึ้นชื่อของอนุสาวรีย์พระยาสุรินทรภักดีศรีณรงค์จางวาง<a
              href="Productseven"
            ></a>
          </a-menu-item>
          <a-menu-item key="20">
            สินค้าขึ้นชื่อของหมู่บ้านทอผ้าไหมบ้านท่าสว่าง<a
              href="Producteight"
            ></a>
          </a-menu-item>
          <a-menu-item key="21">
            สินค้าขึ้นชื่อของศาลหลักเมืองสุรินทร์<a href="Productnine"></a>
          </a-menu-item>
          <a-menu-item key="22">
            สินค้าขึ้นชื่อของตลาดช่องจอม<a href="Productten"></a>
          </a-menu-item>
        </a-sub-menu>
        <!-- | -->
        ...
        <a-sub-menu key="sub3">
          ...
          <a-menu-item key="23">
            บริการที่ใกล้กับปราสาทศรีขมรภูมิ <a href="serviceone"></a>
          </a-menu-item>
          <a-menu-item key="24">
    ...
    <a-layout>
      ...
      <a-layout-content style="margin: 0 16px">
        <a-breadcrumb style="margin: 16px 0">
          <a-breadcrumb-item>อ่างเก็บน้ำห้วยเสนง</a-breadcrumb-item>
        ...
        >
          ...
          <div>
            ...
            <img
              alt="Vue "
              src="../assets/อ่างเก็บน้ำห้วยแสนง.jpg"
              style="width: 35%"
            />
              ...
              <a-descriptions-item label="ลักษณะ">
                <blockquote style="margin: 25px 50px 75px 100px">
                  <p style="text-indent: 50px; font-size: 16px" width="480">
                    ...
                    มีสันเขื่อนสูง สันเขื่อนเป็นถนนราดยาง
                    ลำห้วยเสนงเป็นแหล่งน้ำธรรมชาติที่เกิดจากเทือกเขาพนมดงรักทางตอนใต้ของจังหวัดสุรินทร์
                    ไหลขึ้นมาทางตอนกลางของจังหวัด เป็นธารน้ำขนาดใหญ่
                    ผ่านหลายบริเวณในเขตตำบลเฉนียง อำเภอเมืองสุรินทร์
                    เดิมเป็นธารน้ำ ที่เชื่อมต่อกับคูเมืองชั้นนอกของเมือง
                    ประทายสมันต์หรือเมืองสุรินทร์
                    ต่อมาได้มีการก่อสร้างอ่างเก็บน้ำห่างจากตัวเมืองสุรินทร์ไปทางทิศใต้
                    6 กิโลเมตร มีร่องน้ำ
                    และคลองส่งน้ำเพื่อการเกษตรกระจายทั่วพื้นที่ในเขตอำเภอเมืองสุรินทร์
                    ไหลลงลำห้วยชีทางทิศตะวันตกของอำเภอเมืองสุรินทร์
                    อ่างเก็บน้ำห้วยเสนงเป็นสถานที่พักผ่อนหย่อนใจของชาวเมืองสุรินทร์และนักท่องเที่ยวจากจังหวัดใกล้เคียง
                    และได้ชื่อว่าเป็น ทะเลสุรินทร์
                    นักท่องเที่ยวมักจะนิยมเข้ามาเล่นน้ำ
                    และรับประทานอาหารพื้นบ้านริมสันเขื่อน
                    โดยเฉพาะในช่วงเดือนเมษายนที่มีการจัดงานวันสงกรานต์
                    นอกจากนี้ภายในที่ทำการชลประทานบริเวณบนสันเขื่อน
                    มีสันที่กว้างออกคล้ายแหลมไปซึ่งที่ตั้งพระตำหนักที่ประทับของสมเด็จพระศรีนครินทราบรมราชชนนี
                    และยังเป็นที่ประทับรับรองพระบรมวงศานุวงศ์หลายพระองค์ เช่น
